...
import FONT_ASWESOME from '@salesforce/resourceUrl/fontawesome'
export default class MemoryGameLwc extends LightningElement {
    ...
    get gameRating(){
        let stars = this.moves < 9 ? [1,2,3] : this.moves <= 13 ? [1,2] : [1]
    ...
    renderedCallback(){
        if(!this.isLibLoaded){
            loadStyle(this, FONT_ASWESOME + '/fontawesome/css/font-awesome.min.css').then(() => {
